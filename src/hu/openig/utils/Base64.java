...
public final class Base64 {
	...
	/**
	 * @param options the alphabet options
	 * It's possible, though silly, to specify ORDERED <b>and</b> URLSAFE
	 * in which case one of them will be picked, though there is
	 * no guarantee as to which one will be picked.
	 * @return one of the SOMETHING_ALPHABET byte arrays depending on
	 ...
	 * in which case one of them will be picked, though there is
	 * no guarantee as to which one will be picked.
	 * @return one of the SOMETHING_DECODABET byte arrays depending on
	 * the options specified.
	 */
	...
	/**
	 * Encodes up to the first three bytes of array {@code threeBytes}
	 * and returns a four-byte array in Base64 notation.
	 * The actual number of significant bytes in your array is
	 * given by {@code numSigBytes}.
	 * The array {@code threeBytes} needs only be as big as
	 * {@code numSigBytes}.
	 * Code can reuse a byte array by passing a four-byte array as {@code b4}.
	 *
	...
	/**
	 * <p>Encodes up to three bytes of the array {@code source}
	 * and writes the resulting four Base64 bytes to {@code destination}.
	 * The source and destination arrays can be manipulated
	 * anywhere along their length by specifying 
	 * {@code srcOffset} and {@code destOffset}.
	 * This method does not check to make sure your arrays
	 * are large enough to accomodate {@code srcOffset} + 3 for
	 * the {@code source} array or {@code destOffset} + 4 for
	 * the {@code destination} array.
	 * The actual number of significant bytes in your array is
	 * given by {@code numSigBytes}.</p>
	...
	/**
	 * Decodes four bytes from array {@code source}
	 ...
	 * {code srcOffset} and {@code destOffset}.
	 * This method does not check to make sure your arrays
	 * are large enough to accomodate {@code srcOffset} + 4 for
	 * the {@code source} array or {@code destOffset} + 3 for
	 * the {@code destination} array.
	...
	public static class InputStream extends java.io.FilterInputStream {
		 ...
		 * is reached or {@code len} bytes are read.
	...
	public static class OutputStream extends java.io.FilterOutputStream {
		...
		/**
		 * Calls {@link #write(int)} repeatedly until {@code len} 
		 * bytes are written.
		 *
